...
KID2016$public_insurance <- 0
KID2016$public_insurance[KID2016$PAY1 == "Medicare" | KID2016$PAY1 == "Medicaid"] <- 1

KID2016$other_insurance <- 0
KID2016$other_insurance[KID2016$PAY1 == "Self-pay" | KID2016$PAY1 == "No charge" | KID2016$PAY1 == "Other"] <- 1
...
# Primary payer: Medicare or Medicaid
round(svytable(~ as.character(public_insurance), subset(KID2016survey, SE == 1)))
prop.table(round(svytable(~ as.character(public_insurance), subset(KID2016survey, SE == 1))))

# Primary payer: Other
round(svytable(~ as.character(other_insurance), subset(KID2016survey, SE == 1)))
prop.table(round(svytable(~ as.character(other_insurance), subset(KID2016survey, SE == 1))))
...
# Primary payer: Medicare or Medicaid
round(svytable(~ as.character(public_insurance), subset(KID2016survey, SE == 1 & ventupto96h == 0 & ventmore96h == 0)))
prop.table(round(svytable(~ as.character(public_insurance), subset(KID2016survey, SE == 1 & ventupto96h == 0 & ventmore96h == 0))))

# Primary payer: Other
round(svytable(~ as.character(other_insurance), subset(KID2016survey, SE == 1 & ventupto96h == 0 & ventmore96h == 0)))
prop.table(round(svytable(~ as.character(other_insurance), subset(KID2016survey, SE == 1 & ventupto96h == 0 & ventmore96h == 0))))
...
# Primary payer: Medicare or Medicaid
round(svytable(~ as.character(public_insurance), subset(KID2016survey, SE == 1 & ventupto96h == 1 & ventmore96h == 0)))
prop.table(round(svytable(~ as.character(public_insurance), subset(KID2016survey, SE == 1 & ventupto96h == 1 & ventmore96h == 0))))

# Primary payer: Other
round(svytable(~ as.character(other_insurance), subset(KID2016survey, SE == 1 & ventupto96h == 1 & ventmore96h == 0)))
prop.table(round(svytable(~ as.character(other_insurance), subset(KID2016survey, SE == 1 & ventupto96h == 1 & ventmore96h == 0))))
...
# Primary payer: Medicare or Medicaid
round(svytable(~ as.character(public_insurance), subset(KID2016survey, SE == 1 & ventmore96h == 1)))
prop.table(round(svytable(~ as.character(public_insurance), subset(KID2016survey, SE == 1 & ventmore96h == 1))))

# Primary payer: Other
round(svytable(~ as.character(other_insurance), subset(KID2016survey, SE == 1 & ventmore96h == 1)))
prop.table(round(svytable(~ as.character(other_insurance), subset(KID2016survey, SE == 1 & ventmore96h == 1))))
...
svymean(~ COST, subset(KID2016survey, SE == 1 & public_insurance == 1), na.rm = TRUE)
svyquantile(~ COST, subset(KID2016survey, SE == 1 & public_insurance == 1), c(0.25, 0.5, 0.75), na.rm = TRUE)

svymean(~ COST, subset(KID2016survey, SE == 1 & other_insurance == 1), na.rm = TRUE)
svyquantile(~ COST, subset(KID2016survey, SE == 1 & other_insurance == 1), c(0.25, 0.5, 0.75), na.rm = TRUE)
...
svymean(~ COST, subset(KID2016survey, SE == 1 & ventupto96h == 0 & ventmore96h == 0 & public_insurance == 1), na.rm = TRUE)
svyquantile(~ COST, subset(KID2016survey, SE == 1 & ventupto96h == 0 & ventmore96h == 0 & public_insurance == 1), c(0.25, 0.5, 0.75), na.rm = TRUE)

svymean(~ COST, subset(KID2016survey, SE == 1 & ventupto96h == 0 & ventmore96h == 0 & other_insurance == 1), na.rm = TRUE)
svyquantile(~ COST, subset(KID2016survey, SE == 1 & ventupto96h == 0 & ventmore96h == 0 & other_insurance == 1), c(0.25, 0.5, 0.75), na.rm = TRUE)
...
svymean(~ COST, subset(KID2016survey, SE == 1 & ventupto96h == 1 & ventmore96h == 0 & public_insurance == 1), na.rm = TRUE)
svyquantile(~ COST, subset(KID2016survey, SE == 1 & ventupto96h == 1 & ventmore96h == 0 & public_insurance == 1), c(0.25, 0.5, 0.75), na.rm = TRUE)

svymean(~ COST, subset(KID2016survey, SE == 1 & ventupto96h == 1 & ventmore96h == 0 & other_insurance == 1), na.rm = TRUE)
svyquantile(~ COST, subset(KID2016survey, SE == 1 & ventupto96h == 1 & ventmore96h == 0 & other_insurance == 1), c(0.25, 0.5, 0.75), na.rm = TRUE)
...
svymean(~ COST, subset(KID2016survey, SE == 1 & ventmore96h == 1 & public_insurance == 1), na.rm = TRUE)
svyquantile(~ COST, subset(KID2016survey, SE == 1 & ventmore96h == 1 & public_insurance == 1), c(0.25, 0.5, 0.75), na.rm = TRUE)

svymean(~ COST, subset(KID2016survey, SE == 1 & ventmore96h == 1 & other_insurance == 1), na.rm = TRUE)
svyquantile(~ COST, subset(KID2016survey, SE == 1 & ventmore96h == 1 & other_insurance == 1), c(0.25, 0.5, 0.75), na.rm = TRUE)
...
KID2016_regression <- svyglm(COST ~ AGE + FEMALE + AWEEKEND + HOSP_REGION + HOSP_BEDSIZE + EDrecords + ELECTIVE +
                               AWEEKEND + private_insurance + other_insurance + race_dichotomized + high_income + LOS +
